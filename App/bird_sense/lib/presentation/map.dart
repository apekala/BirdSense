...
class MapPage extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List istapped = [];
    MarkersBloc().add(MarkersAdd(marker: const LatLng(52.21769884997918, 21.01443708154715)));
        ...
        builder: (context, state) {
          ...
          if (state is MarkersLoaded){
              ...
              if (state.markers.isEmpty){
                    context.read<MarkersBloc>().add(MarkersAdd(marker: const LatLng(52.21769884997918, 21.01443708154715)));
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      IconButton(
                                        ...
                                        color: Colors.black,                                      
                                        onPressed:() {
                                          context.read<MarkersBloc>().add(MarkersRemove(marker: state.markers[index]));
                            ...
                            IconButton(
                              onPressed: addState.value?(){}:() {
                                ...
                                for(var i=0; i<istapped.length; i++){
                                 ...
                                 context.read<MarkersBloc>().add(MarkersRefresh());
                ...
                child: GestureDetector(
                  onTap: () {
                    ...
                    if(replaceMarkerState.value ){
                      context.read<MarkersBloc>().add(MarkersChange(marker: positionState.value, index: indexState.value));

                      replaceMarkerState.value = false;
                    }
                    else{     
                    context.read<MarkersBloc>().add(MarkersAdd(marker: positionState.value ));
                    }
